...
#include "lprintf.h"
 ...
 #define SCREEN_WIDTH 320
 #define SCREEN_BUFFER md_screen
#endif
...
void menu_init(void)
{
	...
	readpng(menu_font_data, "skin/font.png", READPNG_FONT, 40, 40); // clort - no idea about size 40
	memcpy(menu_font_data, menu_font_data + ((int)'>')*4*10, 4*10); // default selector symbol is '>'
	readpng(menu_font_data, "skin/selector.png", READPNG_SELECTOR, 40, 40); // clort - no idea about size 40
